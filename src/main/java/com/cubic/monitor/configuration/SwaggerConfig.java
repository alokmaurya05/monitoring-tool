package com.cubic.monitor.configuration;
...
public class SwaggerConfig
{
    ...
    public void postConstruct() throws ClassNotFoundException {
        ...
        for (BeanDefinition beanDef : provider.findCandidateComponents("com.cubic.monitor.controller")) {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                ...
                .description("monitor to given URL ")
                .version("1.0")
